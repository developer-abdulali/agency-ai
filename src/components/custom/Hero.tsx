      ...
      >
        ...
        <div className='relative mt-12 max-w-screen-xl mx-auto isolate rounded-xl md:mt-16'>
          ...
          <motion.div
            ...
            className='absolute bg-primary inset-5 blur-[50px] scale-y-75 -z-10'
          />
          ...
          <motion.div
            ...
            className='absolute bg-primary inset-0 blur-[200px] scale-y-75 scale-x-125 rounded-full -z-10'
          />
        </div>
      </motion.div>
    </section>
